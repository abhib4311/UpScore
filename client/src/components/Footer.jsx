    ...
    <footer className="bg-white dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
              ...
              <div className="grid grid-cols-2 sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-gray-500 font-medium">
                          <li className="mb-4">
                              <Link to="https://flowbite.com/" className="hover:underline">UpScore</Link>
                          </li>
                          <li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <Link to="https://flowbite.com/" className="hover:underline">UpScore</Link>. All Rights Reserved.
              </span>
